...
//====================GENERAL====================//
$(function () {
    $(document).on("dblclick", "#customersTable td:not(:first-child), #productsTable td:not(:first-child), #categoryTable td:not(:first-child)", function (e) {
...
function update(targetColumn, newValue, referenceValue) {
    $.ajax({
        ...
        custom_notify(`${custom_capitalizeFirstLetter(tableType)} was successfully updated.`, null);
