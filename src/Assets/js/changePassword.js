...
$(function () {
  $(document).on("click", ".settings-item", function (e) {
    ...
    $("#changePasswordModal")
      .find(".window-title")
      .html(`Change ${custom_capitalizeFirstLetter(userType)} Password`);
  });

  $(document).on("click", "#confirmNewPassword", function (e) {
    var userType =
      document.getElementById("confirmNewPassword").data["userType"];
        ...
        $.ajax({
          ...
          .done(function (data) {
            ...
            if (updateResult === "success") {
              ...
              delete document.getElementById("confirmNewPassword").data[
                "userType"
              ];
              custom_notify(
                `${custom_capitalizeFirstLetter(
                  userType
